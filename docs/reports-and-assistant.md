...
This page is now **[Reports and the Assistant](https://taskuary.com/docs/reports)** on the documentation site.

The documentation is written once, in `docs/site/`, and built into `site/docs/` — so there is
one copy of every sentence rather than one per place somebody might look. This stub stays so that
existing links keep working.

- [The whole documentation](https://taskuary.com/docs/)
- [Start here](https://taskuary.com/docs/) — install, first run, where your data lives
