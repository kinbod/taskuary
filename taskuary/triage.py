...
FIELDS = {
    ...
    'idea_context':
        'idea_context means this line was GENERATED by the Advisor (the report that reviews everything and raises '
        'ideas), not sent by a person - call it the Advisor in the summary: it names the '
    ...
    'assistant_said':
        'assistant_said is what the Advisor already raised about this very thread (a follow-up it '
...
INTENT_SYSTEM = (
    ...
    'Almost everything that asks for anything is a task. WHO does it is kind, and it is never the coding agent by default.\n'
    'kind ROUTES the task to one of three places, so answer it as its own question:\n'
    '  coding - work INSIDE a system this install holds the code or the credentials for: a change to one of the owner\'s '
    'repositories, a query against one of their databases, a file or report produced from them. The test is where the '
    'work happens, not what it is about: a repository whose SUBJECT matches the message is not a reason. Chasing a '
    'person, asking a vendor, following up by email is never coding. Coding is not the default.\n'
    '  general - nothing to type at a system, but thinking, reading or research would help: weigh an option, make '
    'sense of a thread, work out what to ask, get ready for something, a person to chase or a follow-up to write. '
    'It opens a CONVERSATION with the assistant, which drafts for the owner\'s yes.\n'
    ...
    'Cannot tell? Say task: it lands on the owner\'s own list and nothing starts on a guess.\n'
