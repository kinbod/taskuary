...
class ApiTests(unittest.TestCase):
    ...
    def test_preview_ok_and_error(self):
        ...
        try:
            ...
            REGISTRY.pop('_p')
        r = c.post('/api/reports/preview', json={'type': 'graphql'}).json()
    ...
    def test_report_types(self):
        ...
        self.assertEqual(d['graphql'], 'planned')
    ...
    def test_not_mine_writes_memory_and_triage_reads_it(self):
        ...
        push = lambda i: c.post('/api/ingest/push', json={
            'external_id': f'notmine{i}', 'subject': 'Resident refund request - Roe, Sam',
    ...
    def test_approving_a_draft_actually_answers_the_sender(self):
        ...
        tid = c.post('/api/tasks', json={'Title': 'reply to Priya', 'Kind': 'reply'}).json()['taskId']
        mid = server.store.add_message({'TaskId': tid, 'ExternalId': 'graph:AAA', 'Channel': 'email',
                                        'SourceName': 'me@corp.com', 'Subject': 'PTO', 'FromEmail': 'priya@corp.com',
        ...
        with mock.patch.object(server.outbound, 'send_email', return_value={'channel': 'email', 'to': ['priya@corp.com'],
        ...
        self.assertEqual(send.call_args[0][1], ['priya@corp.com'])            # to
    ...
    def test_mine_makes_a_task_for_the_owner_with_nobody_dispatched(self):
        ...
        mid = server.store.add_message({'ExternalId': 'adp:1', 'Channel': 'email', 'SourceName': 'me@corp.com',
                                        ...
                                        'SentAt': '2026-08-19 08:25', 'BodyText': 'Priya Raman needs your approval.',
                                        'Status': 'ignored'})
    ...
    def test_not_a_task_without_learning_deletes_and_teaches_nothing(self):
        ...
        server.store.add_message({'TaskId': tid, 'ExternalId': 'graph:CHAT1', 'Channel': 'teams',
                                  'FromEmail': 'priya@corp.com', 'BodyText': 'yes', 'Status': 'routed'})
        ...
        self.assertNotIn('priya@corp.com', str(server.store.list_memories()))
