...
[![PyPI](https://img.shields.io/pypi/v/taskuary.svg?cacheSeconds=300&release=0.3.5.6&asof=2026-09-17c)](https://pypi.org/project/taskuary/)
...
Taskuary 仍处于早期阶段，目前为 **v0.3.5.6**，1.0 之前可能出现不兼容变更。
