...
// you ("Configuration → Triage & agents"). One long page per rail entry, scrolled to - not a
// second row of tabs, which is what ran off the right edge once there were eleven of them
// (the owner, 2026-09-18). Configuration's sections are the schema's groups, so adding a group
// there adds a rail entry, an anchor and a search crumb at once.
